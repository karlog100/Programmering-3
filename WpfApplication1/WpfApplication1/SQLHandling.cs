...
namespace MailClient
{
    class SQLHandling
    {
         ...
         public static void CreateDatabase()
        {
            ...
            if (!exists)
            {
                string sql = "CREATE TABLE MailList(MessageId varchar(50) not null, Receiver varchar(50), Sender varchar(50), Date varchar(20), Subject varchar(60), Message varchar(555555555), UNIQUE(MessageId))";
        ...
        public static void insetToDatabase(string SQLCOMMAND)
         {
             dbConnection.Open();
